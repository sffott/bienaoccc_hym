...
let _0x134a17 = new Date(),
    ...
    _0x2e716e = 0,
    _0x5bc515 = "ksjsb",
    _0x180c0c = "https://ghproxy.com/https://raw.githubusercontent.com/mrccccj/SHADOW/main/myks.jsonk",
    ksjsbjk = "https://qianxun01.coding.net/p/ks/d/ks/git/raw/master/10sb.json",
  ...
  if (p[_0x5bc515]) {
    ...
    if (a["status"] == 0) {
      if (_0x459e63 >= a["version"]) {
        _0x2e716e = true;
        _0x75eec0 = "https://ghproxy.com/https://raw.githubusercontent.com/mrccccj/SHADOW/main/myks.jsonk";
...
function Envcc(T, c) {
  const p = {
    ...
    'dceom': 'ijzfe',
    'JighY': 'updateMsg',
    'uwDzR': "https://ghproxy.com/https://raw.githubusercontent.com/mrccccj/SHADOW/main/myks.jsonk",
    'CvmUM': function (S, a) {
      return S === a;
    },
    'QfLFC': "JwVvM",
    ...
    [p["QrmhW"]](S, a) {
      if (p["JpIGP"]('ViWHE', p["NOwog"])) {
        if (p["QwtqA"](q, i[p["LTEld"]])) {
          d = true;
          u = "https://ghproxy.com/https://raw.githubusercontent.com/mrccccj/SHADOW/main/myks.jsonk";
